    ...
    func getHalfGauge(rotateAngle: Double? = 0) -> CAShapeLayer {
        ...
        if ringLayer == nil {
            ringLayer = CAShapeLayer.getOval(lineWidth, path: nil, strokeStart: 0, strokeEnd: 0.5, strokeColor: startColor,
                    fillColor: UIColor.clearColor(), shadowRadius: ringShadowRadius, shadowOpacity: ringShadowOpacity, shadowOffsset: CGSizeZero, bounds: newBounds, rotateAngle: M_PI_2, isCircle: isCircle)
